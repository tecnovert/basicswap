...
from basicswap.interface.dimecoin.chainparams import params as dimecoin_params
...
coins_without_segwit = (Coins.PIVX, Coins.DASH, Coins.DIME)
scriptless_coins = (
    Coins.XMR,
    Coins.WOW,
    Coins.PART_ANON,
